...
def projected_cg(H, c, Z, Y, b, trust_radius=..., lb=..., ub=..., tol=..., max_iter=..., max_infeasible_iter=..., return_all=...): # -> tuple[Unknown, dict[str, Unknown]] | tuple[Unknown | Any, dict[str, Unknown]]:
