...
def fisher_exact(table, alternative=...): # -> tuple[float, float] | tuple[Any | float, float] | tuple[Any | float, ndarray[Any, dtype[Any]]]:
...
def combine_pvalues(pvalues, method=..., weights=...): # -> tuple[Any | Unknown, ndarray[Any, dtype[Any]]]:
    """
